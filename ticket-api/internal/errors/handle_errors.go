...
func HandleValidationError(logger pkg.Logger, c *gin.Context, err error) {
	logger.Error(err)
...
func HandleErrorWithStatus(logger pkg.Logger, c *gin.Context, statusCode int, err error) {
	logger.Error(err)
...
func HandleError(logger pkg.Logger, c *gin.Context, err error) {
	logger.Error(err)
